class HpdosBeta < Formula
  ...
  if OS.mac?
    on_macos do
      if Hardware::CPU.arm?
        url "https://github.com/HPD-AI/homebrew-tap/releases/download/hpdos-v0.1.0-beta.1/hpdos-osx-arm64.tar.gz"
        sha256 "298fcd34290496cbaec536f6bbde6bd29b8ea704f8eed5411b88428a8cc3a531"
      else
        url "https://github.com/HPD-AI/homebrew-tap/releases/download/hpdos-v0.1.0-beta.1/hpdos-osx-x64.tar.gz"
    ...
    on_linux do
      if Hardware::CPU.arm?
        url "https://github.com/HPD-AI/homebrew-tap/releases/download/hpdos-v0.1.0-beta.1/hpdos-linux-arm64.tar.gz"
        sha256 "f1d92da27810d5d17ae894b67d56c6e47c4b9d3f37a408ced0b36f4d5b5aa078"
      else
        url "https://github.com/HPD-AI/homebrew-tap/releases/download/hpdos-v0.1.0-beta.1/hpdos-linux-x64.tar.gz"
